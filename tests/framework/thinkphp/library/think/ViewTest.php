...
class viewTest extends \PHPUnit_Framework_TestCase {
	...
	public function testParseTemplate() {
		...
		$this->assertEquals(APP_PATH . 'MODULE_NAME/view/CONTROLLER_NAME/template_name.html', $method->invoke($view_instance, 'template_name'));
	}
	...
	public function testGetThemePath() {
		...
		$method->setAccessible(TRUE);
		$this->assertEquals(APP_PATH . 'MODULE_NAME/view/', $method->invoke($view_instance));
	}
}
